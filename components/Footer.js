...
export default function Footer() {
  const linkStyle = { color: 'var(--fg3)', display: 'inline-flex', alignItems: 'center', gap: '4px', textDecoration: 'none', transition: 'color 0.15s', fontSize: '0.75rem' }
  return (
